...
#
# Lo step legge diversi input:
#
# Nel caso dello XOR, 2 layer:
#
# awk \
#     -v layer_file="models/xor/layer2.txt" \
#     -v input_file="tmp/xor-20250726/layer1.out" \
#     -v output_file="tmp/xor-20250726/layer2.out" \
#     -v target_file="dataset/xor.txt" \
...
#     -f lib/framework/nnet-backward-layer.awk \
#     /dev/null
#
...
BEGIN {
	...
	activation_function = read_layer_file(layer_file, neuron_matrix)
    	...
    	# 4. Leggere i target siamo nel output layer:
