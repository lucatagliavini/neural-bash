...
# Compone "leaky_relu:alpha" se specificato
if [[ "$ACTIVATION_FUNCTION" == "leaky_relu" && -n "$LEAKY_ALPHA" ]]; then
    ACTIVATION_FUNCTION="leaky_relu:${LEAKY_ALPHA}"
fi
...
# Persist topology metadata for future auto-detection
